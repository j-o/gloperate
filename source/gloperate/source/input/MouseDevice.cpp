...
void MouseDevice::move(const glm::ivec2 & pos, int modifier)
{
...
void MouseDevice::buttonPress(int button, const glm::ivec2 & pos, int modifier)
{
    auto inputEvent = cppassist::make_unique<MouseEvent>(
...
void MouseDevice::buttonRelease(int button, const glm::ivec2 & pos, int modifier)
{
    auto inputEvent = cppassist::make_unique<MouseEvent>(
...
void MouseDevice::wheelScroll(const glm::vec2 & delta, const glm::ivec2 & pos, int modifier)
{
    auto inputEvent = cppassist::make_unique<MouseEvent>(
